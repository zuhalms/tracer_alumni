...
<nav class="navbar navbar-expand-lg fixed-top">
    <div class="container-fluid px-3">
        ...
        <div class="ms-auto">
            <a href="logout_admin.php" class="btn btn-outline-danger btn-sm"><i class="bi bi-box-arrow-right me-1"></i>Logout</a>
        </div>
    </div>
</nav>
...
<div class="sidebar">
    <div>
        <div class="profile-box">
            ...
            <div class="admin-role">Tracer Study</div>
        </div>
        <a href="dashboard_admin.php" class="sidebar-link active"><i class="bi bi-speedometer2"></i> Dashboard</a>
        <a href="admin_export.php" class="sidebar-link"><i class="bi bi-file-earmark-excel"></i> Export Data</a>
    </div>
    <div class="mb-3"></div>
</div>
